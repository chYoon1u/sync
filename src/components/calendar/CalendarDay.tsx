...
export function CalendarDay({ dateStr, day, isCurrentMonth, isSelected, todos, onClick }: Props) {
  ...
  return (
    <button
      ...
      className={`flex min-h-0 min-w-0 flex-col items-stretch justify-start overflow-hidden rounded-lg p-1.5 text-left align-top transition ${
        !isCurrentMonth
    ...
    >
      ...
      <span className="block min-h-0 space-y-0.5 overflow-hidden">
